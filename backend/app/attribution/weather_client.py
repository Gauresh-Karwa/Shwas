...
def get_wind_data(lat: float, lon: float, api_key: str) -> WindData | None:
    ...
    return WindData(speed_mps=wind.get('speed', 0.0), direction_deg=wind.get('deg'), description=description, observed_at=datetime.fromtimestamp(data['dt'], tz=timezone.utc))
